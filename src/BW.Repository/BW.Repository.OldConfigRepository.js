...
BW.Repository.OldConfigRepository = function (configFacade) {
    ...
    function _getSource(protocol) {
        switch(protocol) {
            case 'WMS': return BW.Domain.SubLayer.SOURCES.wms;
            case 'WMTS': return BW.Domain.SubLayer.SOURCES.wmts;
            case 'proxyWmts': return BW.Domain.SubLayer.SOURCES.proxyWmts;
            case 'proxyWms': return BW.Domain.SubLayer.SOURCES.proxyWms;
            default: return BW.Domain.SubLayer.SOURCES.wms;
        }
    }
